...
<table class="table table-bordered">
  <tbody>
    ...
    <tr>
      ...
      <td>
        <b>Release:</b> 
          <a href="https://github.com/kubeflow/manifests/releases/tag/v1.11.0">v1.11.0</a>
        <br>
        <b>Branch:</b>
          <a href="https://github.com/kubeflow/manifests/tree/v1.11-branch">v1.11-branch</a>
      </td>
    </tr>
    <tr>
      <th class="table-light">Release Team</th>
      <td>
        <b>Release Manager: </b> Valentina Rodriguez Sosa (<a href="https://github.com/varodrig">@varodrig</a>)
        <br>
        <b>Member:</b> Anya Kramar  (<a href="https://github.com/kramaranya">@kramaranya</a>)
        <br>
        <b>Member:</b> Tarek Abouzeid (<a href="https://github.com/tarekabouzeid">@tarekabouzeid</a>)
        <br>
        <b>Member:</b> Andy Stoneberg (<a href="https://github.com/andyatmiami">@andyatmiami</a>)
        <br>
        <b>Member:</b> Humair Khan  (<a href="https://github.com/humair">@humair</a>)
        <br>
        <b>Member:</b> Matteo Mortari  (<a href="https://github.com/hbelmiro">@tarilabs</a>)
        <br>
        <b>Member:</b> Adysen Rothman (<a href="https://github.com/adysenrothman">@adysenrothman</a>)
        <br>
        <b>Member:</b> Jon Burdo (<a href="https://github.com/jonburdo ">@jonburdo </a>)
        <br>
        ...
        <br>
        <b>Product Manager:</b> Tarek Abouzeid (<a href="https://github.com/tarekabouzeid">@tarekabouzeid</a>)
      </td>
    </tr>
  </tbody>
</table>
...
<table class="table table-bordered">
  ...
  <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="https://github.com/kubeflow/pipelines/releases/tag/2.15.0">v2.15.0</a>
        </td>
      </tr>
      <!-- ======================= -->
      ...
      <tr>
        ...
        <td>KServe</td>
        <td>
          <a href="https://github.com/kserve/kserve/releases/tag/v0.15.2">v0.15.2</a>
        </td>
      </tr>
      <!-- ======================= -->
      ...
      <tr>
        ...
        <td>
          <a href="https://github.com/kubeflow/model-registry/releases/tag/v0.3.4">v0.3.4</a>
        </td>
      </tr>
      <tr>
