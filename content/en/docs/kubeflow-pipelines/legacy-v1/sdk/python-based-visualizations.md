...
<video width="100%" max-width="100%" height="auto" max-height="100%" controls>
  <source src="/docs/kubeflow-pipelines/legacy-v1/videos/tfdv_example_with_taxi_pipeline.webm" type="video/webm">
</video>
...
<video width="100%" max-width="100%" height="auto" max-height="100%" controls>
  <source src="/docs/kubeflow-pipelines/legacy-v1/videos/taxi_custom_visualization.webm" type="video/webm">
</video>
