...
For quickly building component from a python function see [Build component from Python function](/docs/pipelines/building-pipelines/pipelines-sdk/lightweight-python-components/) and [Data Passing in Python components](https://github.com/kubeflow/pipelines/blob/master/samples/tutorials/Data%20passing%20in%20python%20components.ipynb).
...
* Consolidate what you've learned by reading the 
  [best practices](/docs/pipelines/building-pipelines/pipelines-sdk/best-practices) for designing and 
  writing components.
* For quick iteration, 
