...
- The Training Operator control plane [installed](/docs/components/training/legacy-v1/installation/#installing-the-control-plane).
- The Training Python SDK [installed](/docs/components/training/legacy-v1/installation/#installing-the-python-sdk).
...
- Learn more about [the PyTorchJob APIs](/docs/components/training/legacy-v1/user-guides/pytorch/).
