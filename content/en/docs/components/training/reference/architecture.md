...
As a concrete example, PyTorch has several available
...
Note the link above actually doesn't reflect UCC as that's in the actual source
code and can be found in the `torch.distributed.init_process_group`
