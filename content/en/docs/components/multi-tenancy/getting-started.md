...
spec:
  ...
  subjects:
  - properties:
      request.headers[x-goog-authenticated-user-email]: accounts.google.com:userid@email.com   # replace with the email of the user from your Active Directory case sensitive
status: {}
```
