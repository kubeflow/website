...
When running Kubeflow Pipelines as part of a multi-user [Kubeflow Community Distribution](/docs/started/introduction/#kubeflow-community-distribution), how you authenticate the Pipelines SDK will depend on whether you are running your code __inside__ or __outside__ the cluster.
...
The precise method to authenticate from _outside the cluster_ will depend on how you [deployed Kubeflow Community Distribution](/docs/started/installing-kubeflow/#kubeflow-community-distribution). 
