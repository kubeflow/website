...
description = "Run your first integrated pipeline"
weight = 3
+++
...
* KFP deployment with MLflow integration enabled and connected to a running MLflow server.
  (See the [operator guide](/docs/components/pipelines/operator-guides/mlflow-plugin/) for instructions on MLflow deployment and KFP configuration.)
...
Depending on the complexity of your [pipeline structure](/docs/components/pipelines/user-guides/integrations/mlflow/pipeline-structure-in-mlflow/), these subcomponents may expand further.
