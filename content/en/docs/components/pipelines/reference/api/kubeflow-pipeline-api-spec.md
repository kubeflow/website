...
In most deployments of the [Kubeflow Community Distribution](/docs/started/installing-kubeflow/#kubeflow-community-distribution), the Kubeflow Pipelines REST API is available under the `/pipeline/` HTTP path.
