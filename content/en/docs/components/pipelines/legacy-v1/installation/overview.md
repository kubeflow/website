...
* Kubeflow Pipelines as [part of a full Kubeflow deployment](/docs/started/installing-kubeflow/#kubeflow-distribution) provides
...
1. Do you want to use other Kubeflow components in addition to Pipelines?
    ...
    If yes, choose the [full Kubeflow deployment](/docs/started/installing-kubeflow/#kubeflow-distribution).
...
1. Do you want to use Kubeflow Pipelines with [multi-user support](https://github.com/kubeflow/pipelines/issues/1223)?
    ...
    If yes, choose the [full Kubeflow deployment](/docs/started/installing-kubeflow/#kubeflow-distribution) with version >= v1.1.
...
1. You deploy on other platforms.
    ...
    Please compare your platform specific [full Kubeflow](/docs/started/installing-kubeflow/#kubeflow-distribution) with the
