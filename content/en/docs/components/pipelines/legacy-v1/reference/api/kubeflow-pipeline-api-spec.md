...
In most deployments of the [Kubeflow Distribution](/docs/started/installing-kubeflow/#kubeflow-distribution), the Kubeflow Pipelines REST API is available under the `/pipeline/` HTTP path.
