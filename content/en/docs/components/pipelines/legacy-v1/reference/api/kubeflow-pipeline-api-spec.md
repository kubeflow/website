...
In most deployments of the [Kubeflow Distribution](/docs/started/installing-kubeflow/#kubeflow-distributions), the Kubeflow Pipelines REST API is available under the `/pipeline/` HTTP path.
