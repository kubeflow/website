...
Note: env injection targets always receive `PET_MASTER_ADDR` and `PET_MASTER_PORT`. For TrainJobs
running torchtune, the main trainer container uses a rendezvous endpoint argument instead of these
env vars.
