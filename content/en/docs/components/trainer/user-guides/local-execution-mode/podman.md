...
For a detailed comparison between Docker and Podman and guidance on switching between them, see the [Docker vs Podman section](./overview.md#docker-vs-podman-which-to-choose) in the overview.
