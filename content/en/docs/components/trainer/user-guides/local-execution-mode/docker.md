...
For a detailed comparison between Docker and Podman to help choose the right container runtime, see the [Docker vs Podman section](./overview.md#docker-vs-podman-which-to-choose) in the overview.
