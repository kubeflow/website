...
In most deployments of the [KCD](/docs/started/installing-kubeflow/#kubeflow-distributions), the Kubeflow Model Registry REST API is available under the `/api/model_registry/` HTTP path.
...
The following [Swagger UI](https://github.com/swagger-api/swagger-ui) is automatically generated from the [`{{% hub/latest-version %}}`](https://github.com/kubeflow/hub/releases/tag/v{{% hub/latest-version %}}) version of Kubeflow Model Registry for the [`v1alpha3` REST API](https://github.com/kubeflow/hub/blob/v{{% hub/latest-version %}}/api/openapi/model-registry.yaml).
...
https://raw.githubusercontent.com/kubeflow/hub/refs/tags/v{{% hub/latest-version %}}/api/openapi/model-registry.yaml
{{< /swaggerui-inline >}}
