...
In most deployments of the [KCD](/docs/started/installing-kubeflow/#kubeflow-distribution), the Kubeflow Model Registry REST API is available under the `/api/model_registry/` HTTP path.
