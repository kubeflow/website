...
Contributors are encouraged to discuss, gather feedback and then decide the scope and feature of this project.
...
* Integration with popular LLMs for enhanced user interaction.
* Analysis of telemetry and logs (Reference: [kubeflow/sdk#164](https://github.com/kubeflow/sdk/issues/164)).

**Difficulty:** Medium

**Size:** TBD, 175 hours (Medium) or 350 hours (Large)
