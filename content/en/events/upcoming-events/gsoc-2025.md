...
### Project 4: Standalone Helm Charts

__Components:__ Kubeflow Trainer, Kubeflow Katib, Kubeflow Spark Operator, Kubeflow Model Registry

__Possible Mentors:__ [`@juliusvonkohout`](https://github.com/juliusvonkohout), [`@varodrig`](https://github.com/varodrig)
...
- Deliver at least one proof-of-concept Helm chart for a Kubeflow component.
- The following standalone components are potential candidates for your project:
  - Kubeflow Trainer ([`kubeflow/trainer#1197`](https://github.com/kubeflow/trainer/issues/1197))
  - Kubeflow Katib
  - Kubeflow Spark Operator (already [has chart](https://github.com/kubeflow/spark-operator/tree/master/charts/spark-operator-chart))
  - Kubeflow Model Registry
- __NOTE:__ this is about creating helm charts for [Standalone Components](docs/started/introduction/#what-are-standalone-kubeflow-components) rather than for the overall [Kubeflow Platform](docs/started/introduction/#what-is-kubeflow-platform).
...
- Add support for JAX and TensorFlow training runtimes in Kubeflow Trainer (`TBA`)
...
- Integrate Kubeflow Trainer with Kubeflow Model Registry (`TBA`)
...
- Integrate Volcano Scheduler with Kubeflow Trainer (`TBA`)
