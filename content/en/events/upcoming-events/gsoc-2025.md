...
5. Submit a proposal through the [GSoC website](https://summerofcode.withgoogle.com/) between **March 24th** and **April 8th**. Please look at the guide lines on how to write a [good proposal](https://google.github.io/gsocguides/student/writing-a-proposal). Kubeflow mandates you to use the this [following template](https://github.com/kubeflow/community/tree/master/proposals/gsoc) format to submit your proposal. You would need to submit PDF version of this proposal on GSoC website by April 8th, 2025. 
