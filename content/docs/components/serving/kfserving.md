...
## KFServing with Kubeflow

KFServing can be installed with Kubeflow v0.7, and KFServing Kustomize install files are [located in the manifests repo](https://github.com/kubeflow/manifests/tree/master/kfserving).
...
![KFServing](https://github.com/kubeflow/kfserving/tree/master/docs/diagrams/kfserving.png)
