...
![Creating an ML workspace](images/creatingWS.PNG)
...
![Create Container Reg](images/createContainerReg.PNG)
...
![Create app registration](images/appReg.PNG)
...
![Client ID location](images/clientID2.PNG)
...
![Client secret location](images/password.PNG)
...
![Role assignment](images/roleAssign.PNG)

## Creating Containers from Docker Images
### Install Docker
You need to install Dokcer to be able to push and pull images to/from your Container registry.
