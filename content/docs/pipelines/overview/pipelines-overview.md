...
Kubeflow Pipelines is available as a standalone installation and as a core Kubeflow component.
When installed with Kubeflow, Kubeflow Pipelines automatically deploys with Kubeflow.
To learn how to install Kubeflow Pipelines standalone, see the
[Kubeflow Pipelines standalone installation overview](/docs/pipelines/installation/overview/).
...
* **Kubernetes resources**: The Pipeline Service calls the Kubernetes API
  server. The API server creates the Kubernetes resources
  ([CRDs](https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/custom-resources/)),
  specifying the pipeline execution.
