...
This section shows the how to setup Kubeflow with Authentization and Authorization support in Amazon Web Services (AWS).


## Manifest

In order to simply your setups, we highly recommend you to use this manifest.
[kfctl_aws_cognito.yaml](https://github.com/kubeflow/manifests/blob/master/kfdef/kfctl_aws_cognito.yaml)
...
<img src="/docs/images/aws/cognito-alb-domain.jpg"
...
Before you `apply all -V`, please update Cognito spec in your Kubeflow
