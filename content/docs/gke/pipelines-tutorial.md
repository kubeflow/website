...
<img src="/docs/images/gke/gcp-e2e-ui-prediction.png"
    alt="Prediction UI"
...
1. Follow the instructions in the
  ...
  * The following screenshot shows the Kubeflow deployment UI with hints about
    ...
    <img src="/docs/images/gke/gcp-e2e-deploy-kubeflow.png"
        alt="Prediction UI"
        class="mt-3 mb-3 p-3 border border-info rounded">
...
1. Access the Kubeflow UI, which becomes available at the following URI after
   several minutes:
    ...
    <img src="/docs/images/gke/central-ui.png"
        alt="Prediction UI"
        class="mt-3 mb-3 p-3 border border-info rounded">

1. Click **Pipelines** to access the pipelines UI. The pipelines UI
   looks like this:
    <img src="/docs/images/gke/pipelines-ui.png"
      alt="Pipelines UI"
...
1. Your pipeline now appears in the list of pipelines on the UI.
   Click your pipeline name:
    <img src="/docs/images/gke/pipelines-mnist-uploaded.png"
      alt="Uploaded pipeline in list of pipelines"
      class="mt-3 mb-3 border border-info rounded">

1. The UI shows your pipeline's graph and various options.
   Click **Create run**:
    <img src="/docs/images/gke/pipelines-mnist-graph.png"
...
1.  Supply the following **run parameters**:
  ...
  * batch-size: The batch size for model training.
    ...
    Then click **Start**:
    <img src="/docs/images/gke/pipelines-start-mnist-run.png"
      alt="Starting a pipeline run"
      class="mt-3 mb-3 border border-info rounded">

1. The pipeline run now appears in the list of runs:
    <img src="/docs/images/gke/pipelines-mnist-run-list.png"
...
1. Click the run to see its details. In the following screenshot, the first
   ...
   component (`web-ui`) is still running:
    <img src="/docs/images/gke/pipelines-mnist-running.png"
      alt="A running pipeline"
      class="mt-3 mb-3 border border-info rounded">

1. Click on any component to see its logs.
    <img src="/docs/images/gke/pipelines-mnist-logs.png"
