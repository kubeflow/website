...
1. Using certain hypervisors might require you to set --vm-driver option [specifying the driver](https://github.com/kubernetes/minikube/blob/{{< param "githubbranch" >}}/docs/drivers.md)
you want to use.
...
```
$ curl -O https://raw.githubusercontent.com/kubeflow/kubeflow/{{< param "githubbranch" >}}/bootstrap/bootstrapper.yaml
```
