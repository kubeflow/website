...
description = "Use Kubeflow Fairing to train and deploy a model on Google Cloud Platform from a local notebook."
weight = 30
+++

This guide introduces you to using Kubeflow Fairing to train and deploy a
model to Kubeflow on Google Kubernetes Engine, and Google Cloud ML Engine.
As an example, this guide uses a local notebook to demonstrate how to:

*  Train an XGBoost model in a local notebook,
*  Use Kubeflow Fairing to train an XGBoost model remotely on Kubeflow,
*  Use Kubeflow Fairing to train an XGBoost model remotely on Google Cloud ML Engine, 
...
In order to use Kubeflow Fairing to train or deploy to Kubeflow on Google
Kubernetes Engine, or Google Cloud Machine Learning Engine, you must configure
your development environment with access to Google Cloud Platform. 

1.  If you do not have the Google Cloud SDK installed, [install the Google
...
1.  Kubeflow Fairing needs a service account to make API calls to Google Cloud
    Platform (GCP). The recommended way to provide Fairing with access to this
    ...
    If you do not have a service account, then let's create one and grant it
...
1.  If you do not have a Kubeflow environment, follow the guide to [deploying
    Kubeflow on GKE][kubeflow-install] to set up your Kubeflow environment.
    ...
    *  The [Kubeflow deployment user interface][kubeflow-deploy] is an easy
       way for you to set up a Google Kubernetes Engine cluster with Kubeflow
       installed, or
...
## Use Kubeflow Fairing to train a model locally and on Google Cloud Platform
...
1.  Follow the instructions in the notebook to train a model locally, on
    Kubeflow, and on Google Cloud ML Engine. Then deploy the trained model
...
[kubeflow-install]: https://www.kubeflow.org/docs/started/getting-started-gke/
[kubeflow-deploy]: https://deploy.kubeflow.clou
