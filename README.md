...
**Hugo version 0.89.4** or later. The Kubeflow website now uses Hugo 0.89.4 via
Netlify. 
...
1.  Download `hugo_extended_0.89.4_Linux-64bit.tar.gz`
    (or the latest version) from the
    [Hugo releases](https://github.com/gohugoio/hugo/releases/tag/v0.89.4) page.
