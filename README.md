...
**Hugo version 0.85.0** or later. The Kubeflow website now uses Hugo 0.85.0 via
Netlify. 
...
1.  Download `hugo_extended_0.85.0_Linux-64bit.tar.gz`
    (or the latest version) from the
    [Hugo releases](https://github.com/gohugoio/hugo/releases/tag/v0.85.0) page.
